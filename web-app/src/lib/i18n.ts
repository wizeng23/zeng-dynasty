...
export const translations = {
  ...
  bioScanned: ["Biography (from scan)", "生平（扫描识别）"],
  bioBirth: ["Born", "生"],
  bioSons: ["Sons", "生子"],
  bioDaughters: ["Daughters", "生女"],
  bioFullText: ["Full transcription", "全文识别"],
  bioOcrNote: [
    "Read from the scanned book by OCR — may contain errors.",
    "由扫描件 OCR 识别，可能有误。",
  ],
  notes: ["Notes", "备注"],
